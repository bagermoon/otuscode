...
public class Pagination
{
   ...
   public int Take { get; }
    ...
    public Pagination(int itemsCount, BaseFilter baseFilter)
        : this(new PaginationSettings(10, 100), itemsCount, baseFilter.PageSize, baseFilter.PageNumber)
    {
    }

    public Pagination(PaginationSettings paginationSettings, int itemsCount, BaseFilter baseFilter)
        : this(paginationSettings, itemsCount, baseFilter.PageSize, baseFilter.PageNumber)
    {
    }
