...
using NSubstitute;
using RestoRate.RestaurantService.Application.UseCases.RestaurantImage.AddRestaurantImage;
...
namespace RestoRate.RestaurantService.UnitTests.UseCases.RestaurantImage.AddRestaurantImage;
