...
using NSubstitute;
using RestoRate.Restaurant.Application.UseCases.RestaurantImage.SetPrimaryImage;
...
namespace RestoRate.Restaurant.UnitTests.UseCases.RestaurantImage.SetPrimaryImage;
