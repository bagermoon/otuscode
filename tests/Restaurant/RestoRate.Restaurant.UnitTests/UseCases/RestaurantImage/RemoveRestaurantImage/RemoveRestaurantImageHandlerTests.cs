...
using NSubstitute;
using RestoRate.Restaurant.Application.UseCases.RestaurantImage.RemoveRestaurantImage;
...
namespace RestoRate.Restaurant.UnitTests.UseCases.RestaurantImage.RemoveRestaurantImage;
